...
/*****************************************************************************/
//             Déclarations des sous-fonctions privées "static"              //
/*****************************************************************************/
...
Retour: Aucun
*/
static void ecrire_nb_entrees_sorties_portes(FILE* fichier, const t_circuit* circuit) {
...
Retour: Aucun
*/
static void ecrire_entrees(FILE* fichier, const t_circuit* circuit, char* resultat) {
    int i;
...
Retour: Aucun
*/
static void ecrire_sorties(FILE* fichier, const t_circuit* circuit, char* resultat) {
    int i;
...
Retour: Aucun
*/
static void ecrire_portes(FILE* fichier, const t_circuit* circuit, char* resultat) {
    int i;
...
Retour: Aucun
*/
static void ecrire_liens(FILE* fichier, const t_circuit* circuit, char* resultat) {
    int i;
...
Retour: Aucun
*/
static void charger_entrees(FILE* fichier, t_circuit* circuit, int nb_entrees) {
    int i, id;
    char nom[3];
...
Retour: Aucun
*/
static void charger_sorties(FILE* fichier, t_circuit* circuit, int nb_sorties) {
    int i, id;
    char nom[3];
...
Retour: Aucun
*/
static void charger_portes(FILE* fichier, t_circuit* circuit, int nb_portes) {
    int i, id, type;
    char nom[3];
...
Retour: Aucun
*/
static void charger_liaisons(FILE* fichier, t_circuit* circuit) {
...
*/
static int** allouer_table_verite(int nb_lignes, int nb_colonnes) {
...
Retour: Aucun.
*/
static void generer_table_verite(int** table_verite, int nb_lignes, int nb_entrees) {
    for (int i = 0; i < nb_lignes; ++i) {
...
Retour: Aucun.
*/
static void calculer_sorties_circuit(t_circuit* le_circuit, int** table_verite, int nb_lignes, int nb_entrees, int nb_sorties)
{
    for (int i = 0; i < nb_lignes; ++i)
    {
...
Retour: Aucun.
*/
static void afficher_table_verite(int** table_verite, int nb_lignes, int nb_colonnes, t_circuit* circuit)
{
...
Retour: Aucun.
*/
static void liberer_table_verite(int** table_verite, int nb_lignes) {
    for (int i = 0; i < nb_lignes; ++i) {
        free(table_verite[i]);
    }
    free(table_verite);
...
void circuit_IO_sauvegarder(const char *nom_fichier, const t_circuit *circuit) {
    ...
    printf("\nLe fichier a ete sauvergarde avec succes!\n");
...
void t_circuit_tdv(const t_circuit *le_circuit) 
{
    ...
    //si le circuit est valide on affiche la table, sinon rien !
    if (t_circuit_propager_signal(le_circuit)) {     
